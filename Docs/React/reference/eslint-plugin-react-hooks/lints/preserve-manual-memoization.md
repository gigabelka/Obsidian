...
Validates that existing manual memoization is preserved by the compiler. React Compiler will only compile components and hooks if its inference [matches or exceeds the existing manual memoization](../../../learn/react-compiler/introduction.md#What should I do about useMemo, useCallback, and React.memo?).
