...
React can move `<style>` components to the document's `<head>`, de-duplicate identical stylesheets, and [suspend](../../react/Suspense.md) while the stylesheet is loading.
