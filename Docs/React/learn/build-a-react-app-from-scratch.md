...
>
> For a list of recommended frameworks, check out [Creating a React App](creating-a-react-app.md).
>
...
Vite is already being used as a build tool in one of our [recommended frameworks](creating-a-react-app.md): [React Router](https://reactrouter.com/start/framework/installation).
...
If you don't want to solve these problems on your own, you can [get started with a framework](creating-a-react-app.md) that provides these features out of the box.
