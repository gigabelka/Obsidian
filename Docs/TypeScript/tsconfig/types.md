...
This feature differs from [`typeRoots`](typeRoots.md) in that it is about specifying only the exact types you want included, whereas [`typeRoots`](typeRoots.md) supports saying you want particular folders.
