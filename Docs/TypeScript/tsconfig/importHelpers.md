...
Turning on [`downlevelIteration`](downlevelIteration.md) and `importHelpers` is still false:
...
Then turning on both [`downlevelIteration`](downlevelIteration.md) and `importHelpers`:
...
You can use [`noEmitHelpers`](noEmitHelpers.md) when you provide your own implementations of these functions.
