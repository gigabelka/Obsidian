...
- The initial lib.d.ts lookup based on [`target`](target.md), and the chain of `.d.ts` files which are referenced
- The `index.ts` file located via the default pattern of [`include`](include.md)
