...
Declares the module specifier to be used for importing the `jsx` and `jsxs` factory functions when using [`jsx`](jsx.md) as `"react-jsx"` or `"react-jsxdev"` which were introduced in TypeScript 4.1.
