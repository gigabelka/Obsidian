...
- The [root fields](top-level.md) for letting TypeScript know what files are available
- The [`compilerOptions`](compileroptions.md) fields, this is the majority of the document
- The [`watchOptions`](watchoptions.md) fields, for tweaking the watch mode
- The [`typeAcquisition`](typeAcquisition.md) fields, for tweaking how types are added to JavaScript projects
