...
This flag can only be used when [`allowJs`](allowJs.md) is enabled, and is used if you want to have TypeScript infer types for all of the JavaScript inside your `node_modules`.
