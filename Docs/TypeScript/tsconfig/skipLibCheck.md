...
Note, that if these issues come from the TypeScript standard library you can replace the library using [TypeScript 4.5's lib replacement](../release-notes/typescript-4.5.md#Supporting `lib` from `node_modules`) technique.
