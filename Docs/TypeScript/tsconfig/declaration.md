...
When working with `.d.ts` files for JavaScript files you may want to use [`emitDeclarationOnly`](emitDeclarationOnly.md) or use [`outDir`](outDir.md) to ensure that the JavaScript files are not overwritten.
