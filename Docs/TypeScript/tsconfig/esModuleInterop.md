...
_Note_: You can make JS emit terser by enabling [`importHelpers`](importHelpers.md):
...
Enabling `esModuleInterop` will also enable [`allowSyntheticDefaultImports`](allowSyntheticDefaultImports.md).
