...
**If you're looking for more information about the compiler options in a tsconfig, check out the [TSConfig Reference](../tsconfig/intro.md)**
...
- Every option is fully explained in the [TSConfig Reference](../tsconfig/intro.md).
- Learn how to use a [`tsconfig.json`](tsconfig.json.md) file.
- Learn how to work in an [MSBuild project](compiler-options-in-msbuild.md).
