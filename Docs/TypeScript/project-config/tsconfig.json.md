...
- Using the [`files`](../tsconfig/files.md) property
...
- Using the [`include`](../tsconfig/include.md) and [`exclude`](../tsconfig/exclude.md) properties
...
The `"compilerOptions"` property can be omitted, in which case the compiler's defaults are used. See our full list of supported [Compiler Options](../tsconfig/intro.md).

## TSConfig Reference

To learn more about the hundreds of configuration options in the [TSConfig Reference](../tsconfig/intro.md).
