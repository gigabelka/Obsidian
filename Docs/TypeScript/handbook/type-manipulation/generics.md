...
As we cover in [our section on classes](../classes.md), a class has two sides to its type: the static side and the instance side.
...
This pattern is used to power the [mixins](../../reference/mixins.md) design pattern.
