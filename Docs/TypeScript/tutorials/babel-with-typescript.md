...
To fix these issues, you would probably want to set up a command to type check your project using TSC. This likely means duplicating some of your babel config into a corresponding [`tsconfig.json`](../tsconfig/intro.md) and ensuring these flags are enabled:
...
- [`isolatedModules`](../tsconfig/isolatedModules.md)
- [`declaration`](../tsconfig/declaration.md), [`emitDeclarationOnly`](../tsconfig/emitDeclarationOnly.md)
