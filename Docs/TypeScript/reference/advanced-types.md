...
This page lists some of the more advanced ways in which you can model types, it works in tandem with the [Utility Types](utility-types.md) doc which includes types which are included in TypeScript and available globally.
...
We mentioned these briefly in [the Basic Types section](../handbook/everyday-types.md).
...
The [`strictNullChecks`](../tsconfig/strictNullChecks.md) flag fixes this: when you declare a variable, it doesn't automatically include `null` or `undefined`.
...
From TypeScript 3.7 and onwards, you can use [optional chaining](../release-notes/typescript-3.7.md#Optional Chaining) to simplify working with nullable types.

### Optional parameters and properties

With [`strictNullChecks`](../tsconfig/strictNullChecks.md), an optional parameter automatically adds `| undefined`:
...
Together with [intersection](../handbook/everyday-types.md#Union Types) types, we can make some pretty mind-bending types:
...
TypeScript adds several predefined conditional types, you can find the full list and examples in [Utility Types](utility-types.md).
