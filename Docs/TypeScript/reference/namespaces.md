...
First, we can use concatenated output using the [`outFile`](../tsconfig/outFile.md) option to compile all of the input files into a single JavaScript output file:
