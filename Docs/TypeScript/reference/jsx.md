...
2. Enable the [`jsx`](../tsconfig/jsx.md) option
...
You can specify this mode using either the [`jsx`](../tsconfig/jsx.md) command line flag or the corresponding option [`jsx` in your tsconfig.json](../tsconfig/jsx.md) file.

> \*Note: You can specify the JSX factory function to use when targeting react JSX emit with [`jsxFactory`](../tsconfig/jsxFactory.md) option (defaults to `React.createElement`)
...
- [`jsxFactory`](../tsconfig/jsxFactory.md)
- [`jsxFragmentFactory`](../tsconfig/jsxFragmentFactory.md)
- [`jsxImportSource`](../tsconfig/jsxImportSource.md)
