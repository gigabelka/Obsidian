...
To enable experimental support for decorators, you must enable the [`experimentalDecorators`](../tsconfig/experimentalDecorators.md) compiler option either on the command line or in your `tsconfig.json`:
...
To enable this experimental support, you must set the [`emitDecoratorMetadata`](../tsconfig/emitDecoratorMetadata.md) compiler option either on the command line or in your `tsconfig.json`:
