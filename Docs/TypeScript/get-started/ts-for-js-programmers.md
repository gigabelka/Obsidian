...
A popular use-case for union types is to describe the set of `string` or `number` [literals](../handbook/everyday-types.md#Literal Types) that a value is allowed to be:
...
- Read the full Handbook [from start to finish](../handbook/the-handbook.md)
