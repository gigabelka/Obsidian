...
If you haven't already, you should read the [TypeScript Handbook](../handbook/basics.md)
...
In that case, you can jump straight to [Modules .d.ts](templates/module.d.ts.md).

The Declaration Files section is broken down into the following sections.

## [Declaration Reference](by-example.md)

We are often faced with writing a declaration file when we only have examples of the underlying library to guide us.
The [Declaration Reference](by-example.md) section shows many common API patterns and how to write declarations for each of them.
This guide is aimed at the TypeScript novice who may not yet be familiar with every language construct in TypeScript.

## [Library Structures](library-structures.md)

The [Library Structures](library-structures.md) guide helps you understand common library formats and how to write a proper declaration file for each format.
...
The [Do's and Don'ts](dos-and-donts.md) section identifies common errors,
...
## [Find and Install Declaration Files](consumption.md)
