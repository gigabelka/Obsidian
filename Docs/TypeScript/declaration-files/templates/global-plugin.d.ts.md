...
[`module.d.ts`](module.d.ts.md), [`module-class.d.ts`](module-class.d.ts.md) and [`module-function.d.ts`](module-function.d.ts.md).

Use [`module-function.d.ts`](module-function.d.ts.md) if your module can be _called_ like a function:
...
Use [`module-class.d.ts`](module-class.d.ts.md) if your module can be _constructed_ using `new`:
...
If your module is not callable or constructable, use the [`module.d.ts`](module.d.ts.md) file.
...
Use the [`global-plugin.d.ts`](global-plugin.d.ts.md) template.
...
Use the [`global-modifying-module.d.ts`](global-modifying-module.d.ts.md) template.
