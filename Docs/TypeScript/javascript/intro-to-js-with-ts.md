...
- Incremental typing in JavaScript [via JSDoc](jsdoc-reference.md)
- Using `// @ts-check` in a JavaScript file
- TypeScript code
- TypeScript with [`strict`](../tsconfig/strict.md) enabled
...
You can find the full list of supported JSDoc patterns [in JSDoc Supported Types](jsdoc-reference.md).
...
If you have a lot of JavaScript files you want to add errors to then you can switch to using a [`jsconfig.json`](../project-config/tsconfig.json.md).
...
To learn more about how JavaScript is interpreted by TypeScript read [How TS Type Checks JS](type-checking-javascript-files.md)
