...
[With TypeScript 3.7](../release-notes/typescript-3.7.md#`--declaration` and `--allowJs`),
...
TypeScript supports most JSDoc tags, you can find [the reference here](type-checking-javascript-files.md).
...
You can learn more about the options in the [tsconfig reference](../tsconfig/intro.md).
