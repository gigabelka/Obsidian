...
TypeScript 1.7 adds `ES6` to the list of options available for the [`module`](../tsconfig/module.md) option and allows you to specify the module output when targeting `ES6`.
