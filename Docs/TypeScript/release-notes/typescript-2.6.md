...
TypeScript 2.6 introduces a new strict checking flag, [`strictFunctionTypes`](../tsconfig/strictFunctionTypes.md).
The [`strictFunctionTypes`](../tsconfig/strictFunctionTypes.md) switch is part of the [`strict`](../tsconfig/strict.md) family of switches, meaning that it defaults to on in [`strict`](../tsconfig/strict.md) mode.
You can opt-out by setting `--strictFunctionTypes false` on your command line or in your tsconfig.json.

Under [`strictFunctionTypes`](../tsconfig/strictFunctionTypes.md) function type parameter positions are checked _contravariantly_ instead of _bivariantly_.
...
Under [`strictFunctionTypes`](../tsconfig/strictFunctionTypes.md) the first assignment is still permitted if `compare` was declared as a method.
...
> if you are using [`importHelpers`](../tsconfig/importHelpers.md) with [`tslib`](https://github.com/Microsoft/tslib), an updated to version 1.8 or later.
...
TypeScript 2.6 adds revised implementation the [`noUnusedLocals`](../tsconfig/noUnusedLocals.md) and [`noUnusedParameters`](../tsconfig/noUnusedParameters.md) [compiler options](../project-config/compiler-options.md).
