...
TypeScript now only strictly enforces the visibility of types in modules if the [`declaration`](../tsconfig/declaration.md) flag is provided. This is very useful for Angular scenarios, for example:
