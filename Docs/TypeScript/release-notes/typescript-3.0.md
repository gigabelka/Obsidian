...
See [Project References handbook page](../project-config/project-references.md) for more documentation.
...
In [`strictNullChecks`](../tsconfig/strictNullChecks.md) mode, a `?` modifier automatically includes `undefined` in the element type, similar to optional parameters.
